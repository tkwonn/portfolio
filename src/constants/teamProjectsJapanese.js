export const teamProjects = [
  ...
  {
    title: 'Connect 4',
    description: "１ヶ月という限られた期間の中、未経験者4名＋メンターによって、開発されたチームプロジェクトです。横5×縦5マスのボード上に、2人のプレイヤーが交代でボールを積み上げて行き、相手よりも先に４つのボールを並べた方が勝ちとなるゲームです。",
    points: "プレイヤーおよびボールに関してはオブジェクト指向（OOP）によって書かれています。ユーザの入力によってボードのマスを4×4 ~ 8×8まで、プレイヤーの人数を2 ~ 4人まで動的に生成されるように作成しました。勝利判定は、最後のチェッカーを焦点として扱うことで、計算回数を減らすことができました。",
